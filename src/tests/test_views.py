...
class AuthorListViewTest(TestCase):
    ...
    def test_view_url_exists_at_desired_location_current(self) -> None:
        """ Проверка URL-адреса по пути """
        resp = self.client.get('/')
        self.assertEqual(resp.status_code, 200)

    def test_view_url_accessible_by_name_current(self) -> None:
        """ Проверка URL-адреса по имени """
        resp = self.client.get(reverse('current'))
        self.assertEqual(resp.status_code, 200)

    def test_view_uses_correct_template_current(self) -> None:
    ...
    def test_view_url_exists_at_desired_location_all_polls(self) -> None:
        """ Проверка URL-адреса по пути """
        resp = self.client.get('/all_polls/')
        self.assertEqual(resp.status_code, 200)

    def test_view_url_accessible_by_name_all_polls(self) -> None:
        """ Проверка URL-адреса по имени """
        resp = self.client.get(reverse('all_polls'))
        self.assertEqual(resp.status_code, 200)

    def test_view_uses_correct_template_all_polls(self) -> None:
        """ Проверка правильности использования шаблона """
        resp = self.client.get(reverse('all_polls'))
    ...
    def test_view_url_exists_at_desired_location_all_polls_id(self) -> None:
        """ Проверка URL-адреса по пути """
        resp = self.client.get('/all_polls/1')
        self.assertEqual(resp.status_code, 200)

    def test_view_url_accessible_by_name_all_polls_id(self) -> None:
        """ Проверка URL-адреса по имени """
        resp = self.client.get(reverse('selected_poll', args='1'))
        self.assertEqual(resp.status_code, 200)

    def test_view_uses_correct_template_all_polls_id(self) -> None:
        """ Проверка правильности использования шаблона """
        resp = self.client.get(reverse('selected_poll', args='1'))
        self.assertTemplateUsed(resp, 'poll/current.html')
    ...
    def test_view_url_exists_at_desired_location_all_polls_result_id(self) -> None:
        """ Проверка URL-адреса по пути """
        resp = self.client.get('/all_polls/result_1')
        self.assertEqual(resp.status_code, 200)

    def test_view_url_accessible_by_name_all_polls_result_id(self) -> None:
        """ Проверка URL-адреса по имени """
        resp = self.client.get(reverse('poll_result', args='1'))
        self.assertEqual(resp.status_code, 200)

    def test_view_uses_correct_template_all_polls_result_id(self) -> None:
        """ Проверка правильности использования шаблона """
        resp = self.client.get(reverse('poll_result', args='1'))
    ...
    def test_view_url_exists_at_desired_location_create_poll(self) -> None:
        """ Проверка URL-адреса по пути """
        resp = self.client.get('/create_poll')
        self.assertEqual(resp.status_code, 200)

    def test_view_url_accessible_by_name_create_poll(self) -> None:
        """ Проверка URL-адреса по имени """
        resp = self.client.get(reverse('create_poll'))
        self.assertEqual(resp.status_code, 200)

    def test_view_uses_correct_template_create_poll(self) -> None:
        """ Проверка правильности использования шаблона """
        resp = self.client.get(reverse('create_poll'))
